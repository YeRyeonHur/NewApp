                ...
                if (!isValidEmail(id)) {
                    ...
                    if (pwd.equals(pwdcheck) && FLAG == true) {
                        ...
                        firebaseAuth.createUserWithEmailAndPassword(id, pwd).addOnCompleteListener(
                                com.example.A_manager.sign.Register.this, new OnCompleteListener<AuthResult>() {
                                    @Override
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            Intent intent = new Intent(Register.this, com.example.A_manager.calendar_page.calendar.class);
