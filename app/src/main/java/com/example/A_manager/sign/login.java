package com.example.A_manager.sign;
...
import com.example.A_manager.calendar_page.calendar;
import com.example.A_manager.database.PreferenceManager;
...
import com.example.A_manager.R;
...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        find_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //아이디 찾기 화면으로 넘어감
                Intent intent = new Intent(login.this, com.example.A_manager.sign.find_id.class); //this 대신 getActivity()
                startActivity(intent);
            }
        });
        //회원가입 눌렀을때 넘어가게
        join.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //회원가입 화면으로 넘어감
                Intent intent = new Intent(login.this, com.example.A_manager.sign.Register.class); //this 대신 getActivity()
                startActivity(intent);
            }
        });
